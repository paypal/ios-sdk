...
class PYPLValidationResult_Tests: XCTestCase {

    func testValidationResult_initializes_withoutContingencyURL() {
        let result = PYPLValidationResult(json: BTJSON(withJSONFile: "paypal-validation-response-without-contingency")!)
        XCTAssertNil(result.contingencyURL)
    }

    func testValidationResult_initializesAllProperties_withContingencyURL() {
        let result = PYPLValidationResult(json: BTJSON(withJSONFile: "paypal-validation-response-with-contingency")!)
    ...
    func testValidationResult_initializesSomeProperties_withExpiredCardResult() {
        let result = PYPLValidationResult(json: BTJSON(withJSONFile: "paypal-validation-response-card-expired")!)
    ...
    func testValidationResult_initializesSomeProperties_withInvalidToken() {
        let result = PYPLValidationResult(json: BTJSON(withJSONFile: "paypal-validation-response-invalid-token")!)
